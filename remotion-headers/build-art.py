...
<style>
  ...
  *{{margin:0;padding:0;box-sizing:border-box;}}
  ...
  .hero .accentline{{position:absolute;left:0;bottom:0;height:4px;width:100%;z-index:2;background:linear-gradient(90deg,#E0566A,#FFB13C,#E0566A);}}
  ...
  .hero-cta{{margin-left:auto;width:44px;height:44px;border-radius:50%;background:#fff;color:#C23A55;display:flex;align-items:center;justify-content:center;box-shadow:0 8px 18px rgba(0,0,0,.28);}}
  ...
  .pieno.acc{{background:linear-gradient(90deg,#E0566A,#FFB13C);}}
...
<div class="galleria">
  ...
  <div>
    ...
    <div class="phone"><div class="screen"><div class="notch"></div><div class="scroll">
      ...
      <div class="card"><b class="tit">{I('users','18px','#C23A55')} Spese per viaggiatore</b>
...
<div class="nota">
  ...
  <ul>
    <li><span class="d" style="background:#E0566A"></span><div><b>Una scena, tutto il viaggio:</b> la card-gateway mostra la scena piena (Fuji + sole); gli header di Itinerario/Budget riusano lo stesso loop ritagliato su cielo e sole. Continuità totale.</div></li>
...
out = here.parent / "proposta-giappone-art-v6.html"
