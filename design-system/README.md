...
| 13 | Documentazione tecnica finale | 🟡 in corso (docs: ARCHITECTURE, DESIGN_SYSTEM, COMPONENT_GUIDE, CONTRIBUTING, README, CHANGELOG, LICENSE, SECURITY, CODE_OF_CONDUCT + robots/sitemap/404) |
