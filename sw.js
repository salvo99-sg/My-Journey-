...
const CORE = [
  ...
  "app.js",
  "manifest.json",
  "design-system/pwa/icons/icon-192.png",
  "design-system/pwa/icons/icon-512.png",
  "design-system/pwa/icons/apple-touch-icon.png",
  "design-system/pwa/icons/favicon-32.png"
];
